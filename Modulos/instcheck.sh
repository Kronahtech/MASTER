...
echo ""
echo -e "                 \033[1;31mBy @KRONAHTECH\033[1;36m"
echo ""
...
sleep 5
cd /bin || exit
wget https://raw.githubusercontent.com/Kronahtech/MASTER/main/Modulos/initcheck > /dev/null 2>&1
wget https://raw.githubusercontent.com/Kronahtech/MASTER/main/Modulos/userscheck > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/Kronahtech/MASTER/main/Modulos/checkuser.py > /dev/null 2>&1
